import sys
sys.path.append('./src/models/backbones')
import torch.nn as nn
from torch.hub import load_state_dict_from_url
from torchvision.models import ResNet
from models.backbones.senet.se_module import SELayer
...
class CifarSEResNet(nn.Module):
    def __init__(self, block, n_size, num_classes=7, reduction=16):
        super(CifarSEResNet, self).__init__()
        self.inplane = 16
        self.conv1 = nn.Conv2d(
            6, self.inplane, kernel_size=3, stride=1, padding=1, bias=False)
