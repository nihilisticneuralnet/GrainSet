...
__all__ = ['ResNet', 'seresnet18', 'seresnet34', 'seresnet50', 'seresnet101', 'seresnet152']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=8, zero_init_residual=False,
                 ...
                 norm_layer=None, inter_layer=False, dataset_type="imagenet",in_ch=3):
        ...
        if self.dataset_type == "imagenet":
            ...
            self.conv1 = nn.Conv2d(6, self.inplanes, kernel_size=3, stride=1, padding=1,
                                   bias=False)
            self.bn1 = norm_layer(self.inplanes)
            self.relu = nn.ReLU(inplace=True)
        ...
        self.se = SEModule(channels=512 * block.expansion)
